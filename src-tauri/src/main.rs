...
#[tauri::command]
fn opiumware_execute(code: String, port: String) -> String {
...
#[tauri::command]
fn opiumware_attach_any() -> String {
    for p in PORTS {
...
#[tauri::command]
fn opiumware_detach(port: String) -> String {
    format!("Detached from port {}", port)
}

#[tauri::command]
fn opiumware_check_port(port: String) -> bool {
...
fn main() {
  tauri::Builder::default()
    .invoke_handler(tauri::generate_handler![
        opiumware_execute,
        opiumware_attach_any,
        opiumware_detach,
        opiumware_check_port
    ])
